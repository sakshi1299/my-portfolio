    ...
    <Container >
      ...
      <div className={styles.content}>
        ...
        <section id="Experience" className={styles.aboutSection}>
          <h3 className={`${styles.sectionHeading}  ${robotoMono.className}`}>Experience</h3>
          <About />
        </section>
        {/* About section */}
        ...
        <section id="Work" className={styles.workSection}>
          <div className={styles.buttons}>
            ...
            <Grid container className={styles.buttonsContainer}>
            {
              work.map((project, i) => {
                return (
                  <Grid key={i} item  md={12} className={styles.buttonItem}>
      ...
      <h3 className={`${styles.contactHead}  ${robotoMono.className} `}>Contact</h3>
